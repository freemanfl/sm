...
const Navbar = () => {
  ...
  return (
   <nav className="md:py-5 w-full  py-1 nav flex flex-row sticky justify-between bg-transparent items-center top-0 z-10 ">
      <div className="flex space-x-2 ">
        <img src={Logo} alt="logo" className='cursor-pointer' />
        <div className="title">
            <h1 className='font-mon md:text-base text-xs font-bold text-white'>.</h1>
            <h1 className='font-mon md:text-base text-xs text-logoBlack font-bold cursor-pointer'>SHIRA</h1>
            <h1 className='font-mon md:text-base text-xs text-logoBlack font-bold cursor-pointer'>GREEN</h1>
        </div>
      </div>
      <ul className='hidden md:flex items-center space-x-10'>
        <li className='font-mon text-base font-normal cursor-pointer z-30'><a href="#work">WORK</a></li>
        <li className='font-mon text-base font-normal cursor-pointer z-30'><a href="#about">ABOUT</a></li>
        <li className='font-mon text-base font-normal cursor-pointer z-30'><a href="#contact">CONTACT</a></li>
      </ul>
